...
//focusin, change, focusout
    ...
    handleElementEventsOnSubmit: function(elementID,eType) {
        ...
        elementID === 'password' ? helper.passwordOnFocusoutChange(elementID, 'confirmPassword', eType) : null;
        elementID === 'confirmPassword' ? helper.passwordOnFocusoutChange(elementID, 'password', eType) : null;
    ...
    passwordOnFocusoutChange: function(element,comparedElement,eType) {
        var thisElement = $('#'+element);
        var pattern = /^\S{4,}$/;
