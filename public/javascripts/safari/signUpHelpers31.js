...
var helper = {
    ...
    initializeJqueryEvents:  function(){
        ...
        $('#signUpForm').on('input', '.form-control', function(e) {
            e.preventDefault();
            console.log('signUpForm > BUBBLE > input: ', $(document.activeElement))
        });

        $('#signUpForm').on('focusout', '.form-control', function(e) {
            e.preventDefault();
            console.log('signUpForm > BUBBLE > focusoutYY: ', $(this));

        });

        $('#signUpForm').on('focusout', '#displayname', function(e) {
            e.preventDefault();
            console.log('signUpForm > BUBBLE > displayname: ', $(this));
        ...
        $('#signUpForm').on('focus', '#signUpSubmitBtn', function(e) {
            e.preventDefault();
            console.log('signUpForm > BUBBLE > focusAA: ', $(this));
        });

        $('#signUpForm').on('focus', '#password', function(e) {
            e.preventDefault();
            console.log('signUpForm > BUBBLE > focusPP: ', $(this));
        });


        //$('#displayname').on('focus', helper.displaynameOut());
        ...
        $('#displaynameXXX').on('input', function(e) {
        ...
        /*
        $('#signUpSubmitBtn').on('focus', function(e) {
            e.preventDefault();
            //$(this).data('lastActiveElement', dataID);
            console.log('>>>>? signUpForm: ', $(document.activeElement))
        });
        */

        /*
        $("#signUpSubmitBtn").on('click', function() {
            console.log('>>>>? Moooooo: ', $( document.activeElement ))
            $('#displayname').off('change');
        });
        */

        /*
        $('#displaynameXXX').on('focusout', function(e) {
            //helper.displayname('displayname');
            console.log('displayname > focusout > AE: ', $( document.activeElement ))
            var pattern = /^[A-Za-z0-9_]{4,21}$/;
            $(this).on('input', function(){
                helper.testUserInput('displayname',pattern);
            });
        ...
        $( "#displayname" ).on('blur', function(e) {
            console.log('displayname > blur > AE: ', $( document.activeElement ))
            var pattern = /^[A-Za-z0-9_]{4,21}$/;
            $(this).on('input', function(){
                helper.testUserInput('displayname',pattern);
            });
        ...
        */
        ...
        $('#password').on('focusout', function(e) {
            console.log('password > focusout > AE: ', $( document.activeElement ))
            var pattern = /^\S{4,}$/;
            $(this).on('input', function(){
        ...
        $('#password').on('change', function(e) {
            console.log('password > change > AE: ', $( document.activeElement ))
        ...
        $('#confirmPassword').on('focusout', function(e) {
            console.log('>>>>? confirmPassword: ', $( document.activeElement ))
            var pattern = /^\S{4,}$/;
            $(this).on('input', function(){
    ...
    displaynameOut: function(displayname) {
        var pattern = /^[A-Za-z0-9_]{4,21}$/;
    ...
    validateParams: function(validValue, comparedValue) {
