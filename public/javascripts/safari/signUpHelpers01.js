...
var helper = {
    ...
    initializeJqueryEvents:  function(){
        ...
        $('#signUpForm').on('submit', function(e) {
            ...
            console.log('signUpForm > SUBMIT +++ > ae: ', ae);
            e.preventDefault();
        });
        ...
        */
        ...
        // THIS IS OUR "FOCUSOUT" ON FORM ELEMENTS && SETS THE AE +++++++++
        // STOPS PROPAGATION/BUBBLING OF EVENT
        $('#signUpForm').on('focusin', function(e) {
            e.preventDefault();
            e.stopPropagation();

            var ae = $('#signUpForm').data('signUpFormActiveElement');
            console.log('signUpForm > FOCUSIN: ', $(document.activeElement))
            console.log('signUpForm > FOCUSIN > signUpFormActiveElement ++++++++: ', ae);
        ...
        $('body').on('click', '#signUpForm', function(e) {
           console.log('body > CLICK > #signUpForm: ', $(document.activeElement))
        });

        $('#signUpForm').on('change', function(e) {
           console.log('signUpForm > CHANGE: ', $(document.activeElement));
        });

        $('#signUpForm').on('click', function(e) {
           console.log('signUpForm > CLICK: ', $(document.activeElement))
        });

        $('#signUpSubmitBtn').on('click', function(e) {
           console.log('signUpSubmitBtn > CLICK: ', $(document.activeElement))
        });
        ...
        $('body').on('focusin', '.wrapper', function(e) {
           console.log('body > FOCUSIN > wrapper: ', $(document.activeElement))
        });
    ...
    passwordOnFocusout: function(element, helperFunction, pattern) {
        var thisElement = $('#'+element);
        var pattern = /^\S{4,}$/;
        thisElement.on('input', function(){
            helper.testUserInput(element,pattern);
    ...
    emailOnFocusout: function(element, helperFunction, pattern) {
        var thisElement = $('#'+element);
        thisElement.on('input', function(){
            helper.testUserInputEmail(element,pattern);
        });
        helper.testUserInputEmail(element,pattern);
    },
