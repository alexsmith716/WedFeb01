...
var helper = {
    ...
    initializeJqueryEvents:  function(){
        ...
        $('#signUpForm').on('submit', function(e) {
            ...
            for (var constraintElement in data){
                ...
                console.log('signUpForm > SUBMIT > constraintSatisfied FALSE!: ', element, ' :1: ', constraintSatisfied, ' :2: ', emailRegistered);
    ...
    emailOnFocusout: function(element) {
        console.log('emailOnFocusout > element: ', element)
        var thisElement = $('#'+element);
        thisElement.on('input', function(){
    ...
    evaluateValidInputValues: function(str1, str2) {
        if ($('#' + str2).val() !== '') {
